#!/usr/bin/env node
/** Package Starter UX improvements */
import fs from "fs";
...
const outZip = path.join(root, "aigovernancehub-website-starter-ux-improvements.zip");
const exclude = new Set(["node_modules", ".env", ".env.local", ".vercel", ".v25.14-staging"]);
...
const staging = path.join(root, ".ux-staging");
