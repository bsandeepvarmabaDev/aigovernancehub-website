#!/usr/bin/env node
/** Package AI Governance Hub website v25.5 */
import fs from "fs";
...
const outZip = path.join(root, "aigovernancehub-website-v25.5.zip");
const exclude = new Set([
  ...
  ".v22-staging", ".v23-staging", ".v24-staging", ".v25-staging", ".v25.3-staging", ".v25.5-staging", ".v26-staging",
]);
...
const staging = path.join(root, ".v25.5-staging");
