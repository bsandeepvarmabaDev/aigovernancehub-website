#!/usr/bin/env node
/** Package AI Governance Hub website v25.14 */
import fs from "fs";
...
const outZip = path.join(root, "aigovernancehub-website-v25.14-production-buildout.zip");
const exclude = new Set([
  "node_modules", ".env", ".env.local", ".vercel",
  ".v25.8-staging", ".v25.9-staging", ".v25.13-staging", ".v25.14-staging",
]);
...
const staging = path.join(root, ".v25.14-staging");
