#!/usr/bin/env node
/** Package AI Governance Hub website v25.13 production readiness */
import fs from "fs";
...
const outZip = path.join(root, "aigovernancehub-website-v25.13-production-readiness.zip");
const exclude = new Set([
  "node_modules", ".env", ".env.local", ".vercel",
  ".v25.8-staging", ".v25.9-staging", ".v25.13-staging",
]);
...
const staging = path.join(root, ".v25.13-staging");
