#!/usr/bin/env node
/** Package AI Governance Hub website v25.19 */
import fs from "fs";
...
const outZip = path.join(root, "aigovernancehub-website-v25.19-operations-readiness.zip");
const exclude = new Set([
  "node_modules", ".env", ".env.local", ".vercel",
  ".v25.19-staging", "certification-v25", "certification-final-v25",
]);
...
const staging = path.join(root, ".v25.19-staging");
