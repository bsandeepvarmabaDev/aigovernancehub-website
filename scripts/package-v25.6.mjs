#!/usr/bin/env node
/** Package AI Governance Hub website v25.6 */
import fs from "fs";
...
const outZip = path.join(root, "aigovernancehub-website-v25.6.zip");
const exclude = new Set([
  ...
  "aigovernancehub-website-v25.6.zip", "aigovernancehub-website-v26.0.zip",
  ".v22-staging", ".v23-staging", ".v24-staging", ".v25-staging", ".v25.3-staging",
  ".v25.5-staging", ".v25.6-staging", ".v26-staging",
]);
...
const staging = path.join(root, ".v25.6-staging");
