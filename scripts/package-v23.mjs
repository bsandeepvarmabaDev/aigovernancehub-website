#!/usr/bin/env node
/**
 * Package aigovernancehub-website v23.0 as ZIP (excludes node_modules)
 */
import fs from "fs";
...
const outZip = path.join(root, "aigovernancehub-website-v23.0.zip");
...
const exclude = new Set([
  ...
  ".env.local",
  ".vercel",
  "aigovernancehub-website-v22.0.zip",
...
const staging = path.join(root, ".v23-staging");
